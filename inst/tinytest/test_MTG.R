...
expect_equal(mtg1$GWAResult[[1]]$pValue,
             rep(c(4.28068222689828e-121, 0.960604256923414, 0.318227779346518),
                 times = 3))
expect_equal(mtg1$GWAResult[[1]]$effect,
             c(-0.872253781480284, -0.014046191596225, 0.123883152061834,
               -9.39827640036212, -0.0347502741529574, -0.0751942786184453,
               0.28186485360663, 0.0565051030727408, 0.184737941923968))

...
The cleaned gData object can be used for performing multi trait GWAS analysis. In the examples below the trial Mur13W is used to demonstrate the options of the *runMultiTraitGwas* function. 
```{r mtg}
...
### Estimation of common SNP effects and QTL x E effects.

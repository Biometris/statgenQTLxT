...
#' param mm: ns x n matrix of marker scores. No missing data allowed; neither non-segregating markers
...
estimateEffects <- function(Y, W = matrix(1,nrow(Y),1), mm, Vg, Ve, K,

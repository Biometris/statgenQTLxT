...
updateFACPP <- function(y, wStart = NULL, pStart = NULL, m0 = NULL, hetVar = FALSE, maxDiag = 1e4, tolerance = 1e-4, maxIter = 100L, printProgress = FALSE) {
    .Call(`_genStatPipeline_updateFACPP`, y, wStart, pStart, m0, hetVar, maxDiag, tolerance, maxIter, printProgress)
}

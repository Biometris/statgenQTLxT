...
test_that("runSingleTraitGWas produces correct p-values", {
  ...
  expect_equal(result1[[1]]$pValue, c(0.269933551571042, 0.984965446392588, 0.648441699544186, 0.0626857428326675,
    0.866711176390762, 0.120055932703493, 0.770457097615474, 0.94062721218024,
    0.451231728418542, 0.228231902143968, 0.946236384390807, 0.592108077080844,
    0.61930265357976, 0.405860998685856, 0.911116358438532))
  expect_equal(result2[[1]]$pValue, c(0.525193093036643, 0.894587707469969, 0.602679444465947, 0.0970424392791122,
    0.857734879152351, 0.0928126890021485, 0.623720400459772, 0.99078484120111,
    0.437029434265121, 0.212511818760433, 0.973491209528104, 0.579458353874297,
    0.648912926295298, 0.36714314628521, 0.918479093445775))
  expect_equal(result3[[1]]$pValue, c(0.308728292832839, 0.984965446392575, 0.661002824234323, 0.083081633131156,
    0.866711176390762, 0.121327025768191, 0.804170050729862, 0.927403818290261,
    0.465185132885534, 0.264951537810541, 0.946236384390817, 0.598229839636104,

...
test_that("option covModel functions properly", {
  ...
  expect_equal(mtg1$GWAResult[[1]]$pValue,
               rep(c(0.73786419260083, 0.924746676866265, 0.86746920135606),
                   times = 5))
  expect_equal(mtg1$GWAResult[[1]]$effect,
               c(-0.370750392433234, -0.112274218925851, 0.234308675662398,
                 -0.919852151385386, -0.0243946496419967, 1.01521792266796,
                 -0.360623694230653, -0.126571711334828, -0.40794558805792,
                 0.0805515669737055, -0.0350700530526602, 0.238640683128129,
                 -1.68472083374783, -1.30018951708829, 0.725247970448846))
  expect_equal(mtg1$GWAResult[[1]]$effectSe,
               c(0.7694795368559, 0.586319365205735, 0.669451159474665,
                 0.928635336634086, 0.764346322753128, 0.824218600638726,
                 1.2736214414151, 1.12644387190326, 1.16409920482636,
                 0.785471273306221, 0.598937315937699, 0.684110374990151,
                 1.45293325421818, 1.31630414594359, 1.34105470922656))
})

...
test_that("runMultiTraitGwas produces correct values", {
  ...
  #              rep(c(0.847692786956194, 0.797815822221607, 0.453178491341757),
  #                  times = 3))
...
test_that("option covar functions properly", {
  mtg <- runMultiTraitGwas(gData = gDataTest, trials = 1, covar = "V1")
...
test_that("option snpCov functions properly", {
  mtg <- runMultiTraitGwas(gData = gDataTest, trials = 1, snpCov = "M2")
  # expect_equal(mtg$GWAResult[[1]]$pValue,
...
test_that("option subsetmarkers functions properly", {
  ...
  mtg <- runMultiTraitGwas(gData = gDataTest, trials = 1,
...
test_that("option MAF functions properly", {
  mtg <- runMultiTraitGwas(gData = gDataTest, trials = 1, MAF = 0.46)
  expect_equal(nrow(mtg$GWAResult$ph1), 6)
  expect_equivalent(mtg$GWAResult$ph1,
...
test_that("option covModel functions properly", {
  ...
  mtg <- runMultiTraitGwas(gData = gDataTest, trials = 1, covModel = "pw")
  # expect_equal(mtg$GWAResult[[1]]$pValue,
  ...
  mtg1 <- runMultiTraitGwas(gData = gDataTest, trials = 1,
...
test_that("option estCom functions properly", {
  mtg <- runMultiTraitGwas(gData = gDataTest, trials = 1, estCom = TRUE)

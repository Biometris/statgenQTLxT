...
test_that("runMultiTraitGwas option covar functions properly", {
  mtg1 <- runMultiTraitGwas(gData = gDataTest, environments = 1, covar = "V1")
...
test_that("runMultiTraitGwas option snpCov functions properly", {
  mtg2 <- runMultiTraitGwas(gData = gDataTest, environments = 1, snpCov = "M2")

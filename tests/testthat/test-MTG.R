...
test_that("option covModel functions properly", {
  ...
  expect_equal(mtg$GWAResult[[1]]$pValue,
               rep(c(0.0512366844317675, 0.158101605955451, 0.749120419432747),
                   times = 3))
  expect_equal(mtg$GWAResult[[1]]$effect,
               c(-1.42573972769423, 0.235309953075936, -0.0654349144278768,
                 -0.787582176148978, -0.913154824717823, -0.459452261095746,
                 -1.4350769292116, 0.041594506124182, 0.117455828187233))
  expect_equal(mtg$GWAResult[[1]]$effectSe,
               c(0.600461288221769, 0.624145106009971, 0.631671500913176,
                 0.556709501421145, 0.581072773080499, 0.589419063614057,
                 0.542226029058238, 0.574995978457104, 0.587110369390692))

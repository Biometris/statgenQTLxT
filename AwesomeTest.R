...
GWAS <- runSingleTraitGwas(gData = GData, traits = "GY15.BIOGAI_2013_watered", environments = NULL, covar = NULL,
...
resultOrig$Marker_Name <- as.character(resultOrig$Marker_Name)
resultNw <- MGWAS$GWAResult[[1]][MGWAS$GWAResult[[1]]$trait == "anthesis.BIOGAI_2013_watered", ]
